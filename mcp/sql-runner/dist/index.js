...
server.tool('execute_sql', 'Execute a read-only SQL query in the data DB under RLS scope and clearance role.', ExecuteSqlParams, async ({ sql, role, orgId, allowedAccountIds, clearance }) => {
